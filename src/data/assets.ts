...
export const ASSETS: Asset[] = [
  ...
  },
  {
    file: 'TITLE_CARD.png',
    kind: 'overlay',
    title: 'Show title card (between SH01 and SH02)',
    ref: 'the vertical title card of the series',
    ...
    check: ['“THE HAUNTED CREW” spelled exactly, sharp, top third', '“EPISODE 1 / ANSWER THE BELL / PART 1” in the centre, spelled exactly', 'All five people in one row at the bottom, same order and heights as the lineup photo', 'Muted and elegant, not campy horror'],
    group: 'Post graphics',
    note: 'Sits between SH01 and SH02, about 3 s. NOTE: the script asks for a HARD CUT from the broken breath (SH01) straight to bright daylight (SH02), so this card changes that cut (producer decision). Keep the cut hard on both sides: breath stops → card → daylight. VIDEO (Kling, image-to-video, 9:16, 3 s, sound off) from this image: “Almost still title card. A very slow push-in toward the centre. Dust drifts in the air; the lamp glow behind flickers once, softly; the brass bell high in the frame trembles once as if about to ring, then stills. The five people stand still, breathing and blinking naturally; nobody walks, speaks or looks away. Every letter of the text stays perfectly sharp and unchanged.” If the letters wobble in the video: generate the card WITHOUT text (same prompt minus the two text paragraphs), animate that, and set the titles in the edit — series title in an engraved serif such as Cinzel or IM Fell English SC, episode title in Cormorant Garamond. SOUND: one clean brass bell tone under the card, cut dead on the hard cut to daylight.',
  },
  {
